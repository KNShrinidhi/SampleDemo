...
public class Report_Page {
	...
	@FindBy(xpath="//*[@title='GSTIN Sales Summary']")
...
//	Sales Invoice wise Report
	...
	@FindBy(xpath="//*[@title='GSTIN Purchase Summary']")
	public WebElement GSTIN_Purchase_SummaryMenu;
	
	@FindBy(xpath="//*[@title='Sales Summary – Invoice type']")
	public WebElement Sales_Summary_InvoiceTypeMenu;
	
	@FindBy(xpath="//*[@title='Customer Sales Report – B2B']")
	public WebElement Customer_Sales_Report_Menu;
	
	@FindBy(xpath="//*[@title='Supplier Inward Register']")
	...
	@FindBy(xpath="//*[@title='AuditLog Report']")
...
//  Search result list	
	...
	{
		System.out.println("Report menu click");
