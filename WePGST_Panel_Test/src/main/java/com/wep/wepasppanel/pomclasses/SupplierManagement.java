...
public class SupplierManagement 
{
	...
	WebElement EditContactPersonTextBox;
			 ...
			 String address,String Expected) throws Exception
	{
		...
		if(res)
		{
			...
			if(confirmDialogBox.getText().equalsIgnoreCase("Supplier created Successfully"))
			{
				confirmButton.click();
				return true;
			}
		...
		if(res)
		{
			...
			if(res)
			{
				...
				if(confirmDialogBox.getText().equalsIgnoreCase("Are you sure that you want to Edit this Record?"))
				{
					...
					EditContactPersonTextBox.clear();
					EditContactPersonTextBox.sendKeys(ContactPerson);
